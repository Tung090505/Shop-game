    ...
    useEffect(() => {
        const loadData = async () => {
            try {
                ...
                const parent = allCats.find(c => String(c._id) === String(id) || c.slug === id);

                if (parent) {
                    setParentCategory(parent);
                    const children = allCats.filter(c => String(c.parent?._id || c.parent || '') === String(parent._id));
                    setSubCategories(children); // Chỉ hiển thị thư mục con thật sự, không fallback về parent
                }
        ...
        <div className="min-h-screen bg-primary pb-24">
            ...
            <section className="relative h-[40vh] md:h-[50vh] overflow-hidden">
                <div
                    ...
                    style={{ backgroundImage: `url(${getAssetUrl(parentCategory.image) || 'https://images.unsplash.com/photo-1542751371-adc38448a05e?q=80&w=2070'})` }}
                ></div>
                ...
                <div className="container mx-auto px-4 max-w-6xl">
                    {subCategories.length > 0 ? (
                                ...
                                return (
                                    ...
                                    >
                                        <div className="w-full md:w-48 lg:w-56 shrink-0 aspect-[16/9] md:aspect-square overflow-hidden relative">
                                            <img
                                                src={getAssetUrl(item.image) || (itemProducts[0]?.images[0] ? getAssetUrl(itemProducts[0].images[0]) : 'https://via.placeholder.com/400x400?text=GAME')}
                                                alt={item.name}
                        ...
                        <div className="flex items-center justify-center py-32">
                            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[3rem] p-16 text-center max-w-md">
